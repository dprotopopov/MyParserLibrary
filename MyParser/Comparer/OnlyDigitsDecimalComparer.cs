...
namespace MyParser.Comparer
{
    internal class OnlyDigitsDecimalComparer : IPublicationComparer
    {
        ...
        public int Compare(string x, string y)
        {
            ...
            try
            {
                parse = MyLibrary.Types.Decimal.ParseAsString(_regex.Replace(x, string.Empty).Trim());
            }
            ...
            try
            {
                value = MyLibrary.Types.Decimal.ParseAsString(_regex.Replace(y, string.Empty).Trim());
            }
            catch (Exception exception)
            {
                Debug.WriteLine(exception.ToString());
        ...
        public int GetHashCode(string obj)
        {
            ...
            try
            {
                parse = MyLibrary.Types.Decimal.ParseAsString(_regex.Replace(obj, string.Empty).Trim());
            }
            catch (Exception exception)
            {
                Debug.WriteLine(exception.ToString());
