...
namespace MyParser
{
    ...
    public class BuilderInfo : MyLibrary.Collections.Properties, IValueable
    {
        ...
        [Value]
        [Description("Флаги обязательности/необязательности полей")]
        public object Flags
        {
            get
            {
        ...
        [Value]
        [Description("Шаблон xpath для ключа")]
        ...
        [Value]
        [Description("Шаблон регулярного выражения для ключа")]
        ...
        [Value]
        [Description("Шаблон замены регулярного выражения для ключа")]
        ...
        [Value]
        [Description("Шаблон идентификатора записи. Содержит список названий ключей.")]
